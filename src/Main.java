...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    String result = new RentalInfo(new HardCodedMovieRepository()).statement(new Customer("C. U. Stomer", Arrays.asList(new MovieRental("F001", 3), new MovieRental("F002", 1))));
